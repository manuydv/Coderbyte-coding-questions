...
def BinaryReversal(str):
  decimal_padded1 = bin(int(str)).replace("0b","")   

  while len(decimal_padded1) % 8 != 0:
    decimal_padded1 = '0' + decimal_padded1

  decimal_padded = decimal_padded1[::-1]
  return int(decimal_padded, 2)
